...
// <o> Length of one timer tick in uS <0-4294967295>
// <id> timer_tick
#ifndef CONF_TC3_TIMER_RC_TICK
#define CONF_TC3_TIMER_RC_TICK 1000
#endif
// </h>
...
// <e> Event Output Enable
// <id> timer_event_output_wave
#ifndef CONF_TC3_EVENT_OUTPUT_WAVE
#define CONF_TC3_EVENT_OUTPUT_WAVE 0
#endif

// <o> Length of one timer RA tick in uS <0-4294967295>
// <id> timer_ra_tick
#ifndef CONF_TC3_TIMER_RA_TICK
#define CONF_TC3_TIMER_RA_TICK 500
#endif
//</e>
...
// RB register set to 0
#ifndef CONF_TC3_RB
#define CONF_TC3_RB 0
#endif

// Clock set not invert
#ifndef CONF_TC3_CLKI
#define CONF_TC3_CLKI 0
#endif

// The clock is not gated by an external signal.
#ifndef CONF_TC3_BURST
#define CONF_TC3_BURST TC_CMR_BURST_NONE
#endif
...
#ifndef CONF_TC3_RA
#define CONF_TC3_RA (uint32_t)((float)CONF_TC3_TIMER_RA_TICK * CONF_TC3_CLKS_FREQUENCY / 1000000.f)
#endif

#ifndef CONF_TC3_RC
#define CONF_TC3_RC (uint32_t)((float)CONF_TC3_TIMER_RC_TICK * CONF_TC3_CLKS_FREQUENCY / 1000000.f)
#endif

#ifndef CONF_TC3_CMR_REG_VAL
#define CONF_TC3_CMR_REG_VAL                                                                                           \
	(TC_CMR_TCCLKS(CONF_TC3_TCCLKS) | CONF_TC3_CLKI | TC_CMR_BURST(CONF_TC3_BURST)                                     \
	 | TC_CMR_CAPTURE_ETRGEDG(CONF_TC3_ETRGEDG) | (CONF_TC3_ABETRG << TC_CMR_CAPTURE_ABETRG_Pos)                       \
	 | (((~CONF_TC3_EVENT_OUTPUT_WAVE) & CONF_TC3_CPCTRG) << 14) | ((CONF_TC3_EVENT_OUTPUT_WAVE << 15) & TC_CMR_WAVE)  \
	 | (2 << 13) /* WAVSEL = 10 */                                                                                     \
	 | TC_CMR_WAVE)
#endif

#ifndef CONF_TC3_TICKS_PER_US
#define CONF_TC3_TICKS_PER_US 0
#endif
